...
public class ClassResDto {
    ...
    private String mainTeacherName;     // 선생님 이름
    private String subTeacherCode;      // 서브선생님 코드
    private String subTeacherName;      // 선생님 이름
    private String curri;               // 학년급
    private String grade;               // 대상학년
    private String gradeName;           // 대상학년 이름
